...
import fun.iotgo.crawlthing.util.Downloader;
...
public class ComicCrawl {
  ...
  public static void main(String[] args) {
    ...
    try {
      page = webClient
          .getPage("http://www.chuixue.net/manhua/19736/535303.html?page=14");//尝试加载上面图片例子给出的网页
    } catch (Exception e) {
      e.printStackTrace();
    } finally {
      webClient.close();
    ...
    try {
      Downloader.storeBytes(viewimgPath.getBytes(),"/Users/luck/code/crawlthing/src/main/resources/img/viewimg.jpg");
    }catch (Exception e){
      e.printStackTrace();
    }
  }
